...
\tikzstyle{io} = [rectangle, minimum width=1cm, minimum height=1.8cm, text centered, text width=2cm, draw=black, fill=green!30]
\tikzstyle{process} = [rectangle, minimum width=2cm, minimum height=1cm, text centered, text width=2cm, draw=black, fill=red!30]
\tikzstyle{decision} = [rectangle, minimum width=1cm, minimum height=1.8cm, text centered, text width=2cm, draw=black, fill=blue!30]
