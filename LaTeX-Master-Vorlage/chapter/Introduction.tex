...
\todoredefined[inline]{
TODO: Add goals in introduction. Adjust according to additions in text. Improve quote at beginning. Maybe add other applications as well (physical simulation) and how to go over to it?
}