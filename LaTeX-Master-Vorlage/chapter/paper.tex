...
\]
\[
\stackrel{\text{prod.rule}}{=} \frac{\partial F}{\partial f_i} \mu \left( 1 - \frac{1}{\operatorname{tr}(\mathrm{F}^{T}F) + 1}\right) + F \mu \frac{1}{\left(\operatorname{tr}(\mathrm{F}^{T}F) + 1\right)^2} f_i 2  
\]
\[
+ \lambda \frac{\partial J}{\partial f_i} \frac{\partial J}{\partial F}+ \lambda (J- \alpha) \frac{\partial^2 J}{\partial F\partial f_i}
\]
